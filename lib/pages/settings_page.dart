                ...
                children: [
                  Card(
                    ...
                    color: (Provider.of<ThemeProvider>(
                      context,
                    ).themeModel.isDark) ? CupertinoColors.inactiveGray: CupertinoColors.white ,
                    child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CupertinoButton(
                              color: (Provider.of<ThemeProvider>(
                                context,
                              ).themeModel.isDark) ? CupertinoColors.activeBlue: CupertinoColors.link ,
                              minSize: 25,
                              ...
                              child: ListTile(
                                ...
                                trailing: CupertinoSwitch(
                                    value: Provider.of<InterfaceChangeProvider>(
                                      context,
                                    ).interfaceChangeModel.isAndroid,
                                    onChanged: (val) {
